...
namespace SoCFeedback.Controllers
{
    ...
    public class ModulesController : Controller
    {
        ...
        {
            List<Question> questionsList = _context.Question.AsNoTracking().Where(q => q.Status == Status.Active && q.Optional == false).ToList();
        ...
        {
            return _context.ModuleQuestions.AsNoTracking().FirstOrDefault(y => y.QuestionId == moduleQuestion.QuestionId && y.ModuleId == moduleQuestion.ModuleId) != null;
        }
    }
}